...
<head>
    ...
    <!-- Кавычка закрыта, слэш убран: теперь CSS подключится -->
    ...
    <div class="product-page">
        ...
        <div class="product-page__info">
            ...
            <div class="product-price-block">
                <!-- Добавлен ID и атрибут базовой цены для автоматического пересчета -->
                <span class="product-price" id="display-price" data-base-price="<?= $product['price'] ?>">
